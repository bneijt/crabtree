...
pub async fn render_database(database: TomlFile) -> String {
        ...
        .flat_map(|member| {
            let combination_nodes: Vec<JoiningNode> = member
                ...
                .map(|parents| {
                    ...
                    //     parents
                    //         .iter()
                    //         .map(|parent_id| format!("{} --- {:x}", parent_id, hash_result)),
                    // );
                    // nds.push(format!(
                    //     "{:x} --- {}",
                    //     hash_result,
    ...
    // let mut parent_combination_nodes: Vec<String> = members
    //     .iter()
    //     .flat_map(|member| {
    ...
    // let content: Vec<String> = header
    //     .into_iter()
    //     .chain(member_lines)
    //     .chain(parent_combination_nodes)
    //     .collect();
    // content.join("\n").into();
